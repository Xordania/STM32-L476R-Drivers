...
static void USART_IRQHandler(USART_Handle_t *pUSARTHandle){
	...
	event_flag = (pUSARTHandle->pUSARTx->CR1 >> USARTx_ISR_TC) & 1;
	control_bit = (pUSARTHandle->pUSARTx->ISR >> USARTx_CR1_TCIE) & 1;
	...
	event_flag = (pUSARTHandle->pUSARTx->CR1 >> USARTx_ISR_TXE) & 1;
	control_bit = (pUSARTHandle->pUSARTx->ISR >> USARTx_CR1_TXEIE) & 1;
